...
def main():
    ...
    parser.add_argument(
        '--wandb_entity', help="wandb identity (team or username)")
    parser.add_argument(
        '--wandb_project',
        default="",
    ...
    parser.add_argument(
        ...
        "Should be supplied if resuming a wandb logged run is being resumed"
    ...
    # setup wandb on the main process
    ...
    if args.wandb and args.local_rank in [-1, 0]:
        ...
        if os.path.exists(args.model_name_or_path):
            if os.path.join(args.model_name_or_path, 'config':  # dhruvesh
                pass
