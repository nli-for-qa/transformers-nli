...
def read_swag_examples(input_dir, is_training=True):
    """
    :param input_file:  race/train or race /dev
    :param is_training:
    :return:
    """
    ...
    for file in tqdm(files):
        with open(file, 'r', encoding='utf-8') as fin:
            ...
            # print(data_raw)
            if is_training:
                assert data_raw.get("answers", None) is not None
...
def load_and_cache_examples(args, tokenizer, evaluate=False, output_examples=False):
    ...
    input_dir = args.predict_dir if evaluate else args.train_dir
    cached_features_file = os.path.join(os.path.dirname(input_dir), 'cached_{}_{}_{}'.format(
    ...
    if os.path.exists(cached_features_file) and not args.overwrite_cache and not output_examples:
        ...
        examples = read_swag_examples(input_dir)
