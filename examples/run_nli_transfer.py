...
MODEL_CLASSES = {
    ...
    "roberta-nli": (RobertaConfig, RobertaForSequenceClassification,
                    RobertaTokenizer),
    "roberta-nli-sigmoid": (RobertaConfig, RobertaForTransferableEntailment,
                            RobertaTokenizer),
    "roberta-nli-rev-sigmoid":
    (RobertaConfig, RobertaForTransferableEntailment, RobertaTokenizerRev),
    "roberta-qa": (RobertaConfig, RobertaForTransferableMCQ, RobertaTokenizer),
    "roberta-nli-rev": (RobertaConfig, RobertaForSequenceClassification,
                        RobertaTokenizerRev),
    "roberta-qa-rev": (RobertaConfig, RobertaForTransferableMCQ,
                       RobertaTokenizerRev),
