...
def squad_convert_example_to_features(example, max_seq_length, doc_stride, max_query_length, is_training, nsp=1.0):
    features = []
...
def squad_convert_examples_to_features_without_process(examples, tokenizer, max_seq_length, doc_stride, max_query_length,
                                                      is_training, return_dataset=False, threads=0, nsp=1.0):
